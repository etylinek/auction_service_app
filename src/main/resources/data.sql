...
INSERT INTO auction_model (name, description, min_value, buy_now_value, is_promoted, start_date, end_date, views, auction_status,category_model_id,	user_model_id,buyer_id) VALUES ('Mikrofala, uszkodzona', 'Sprzedam uszkodzoną mikrofalówkę.', '60', '70', 'false', '2023-08-14 13:19:37', '2023-08-28 13:19:37', '0','ACTIVE','5','1','2');
INSERT INTO auction_model (name, description, min_value, buy_now_value, is_promoted, start_date, end_date, views, auction_status,category_model_id,	user_model_id,buyer_id) VALUES ('Zmywarka - dobry stan', 'Sprzedam zmywarkę w dobrym stanie, sprawna.', '370', '420', 'false', '2023-08-22 16:26:11', '2023-08-29 16:26:11', '0','ACTIVE','5','2','2');
INSERT INTO auction_model (name, description, min_value, buy_now_value, is_promoted, start_date, end_date, views, auction_status,category_model_id,	user_model_id,buyer_id) VALUES ('Passeratti 1.9TDI', 'Sprzedam Passata. Nie bity, jeżdżone tylko do kościoła', '8500', '9500', 'true', '2023-08-22 11:15:52', '2023-09-02 11:15:52', '4','ACTIVE','1','1','2');
