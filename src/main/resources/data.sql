...
INSERT INTO auction_model (name, description, min_value, buy_now_value, is_promoted, start_date, end_date, views, auction_status) VALUES ('Passatejro', 'Sprzedam Passata. Nie bity, jeżdżone tylko do kościoła', '1500', '1400', 'true', '2022-08-05', '2022-08-23', '4','ACTIVE');
INSERT INTO auction_model (name, description, min_value, buy_now_value, is_promoted, start_date, end_date, views, auction_status) VALUES ('Romet for life', 'Sprzedam rower. Wigry 3 w super stanie', '450', '400', 'false', '2023-01-12', '2023-01-26', '12','ACTIVE');
