                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input class="col-10 form-control" type="text" placeholder="uzupełnij imię">
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">Nazwisko</label>
                                        <input class="col-10 form-control" type="text" placeholder="uzupełnij nazwisko">
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">URL Git</label>
                                        <input class="col-10 form-control" type="text" placeholder="uzupełnij git">
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">Od czego się zaczęło</label>
                                        <textarea class="col-10 form-control" type="text" rows="5" placeholder="uzupełnij od czego się zaczęło"></textarea>
                                    </div>
